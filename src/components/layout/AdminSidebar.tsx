...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 ml-64 flex items-center justify-center pointer-events-none z-0 overflow-hidden select-none">
        <Logo className="w-[60%] lg:w-[40%] h-auto opacity-[0.03] rotate-[-12deg] transform scale-150 grayscale" />
      </div>
    </>
  );
};
